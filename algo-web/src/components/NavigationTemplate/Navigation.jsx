...
import { AiOutlineDollarCircle, AiOutlineUserSwitch } from "react-icons/ai";
...
const Navigation = () => {
  ...
  return (
    <div className={`navigation ${nav && "active"}`}>
      ...
      <Nav Icon={AiOutlineHeart} title={"Favourite stocks"} />
      <Nav Icon={PiStrategyBold} title={"Your algos"} />

      <div className="divider"></div>

      <Nav Icon={MdOutlineNotificationsActive} title={"Notifications"} />
      <Nav Icon={AiOutlineDollarCircle} title={"Earnings"} />
      <Nav Icon={MdOutlineUnsubscribe} title={"Subscription"} />

      <Nav Icon={BsNewspaper} title={"News"} />
      <Nav Icon={FaBlog} title={"Blogs"} />
      <Nav Icon={AiOutlineUserSwitch} title={"Change Account"} />

      <div className="divider"></div>

      <Nav Icon={BiHelpCircle} title="Get help" />
